...
export async function askGemini(message) {
  const prompt = `You are XploitAgent, an intelligent AI assistant built into the XploitAgent cybersecurity platform. Your primary role is to answer questions related to cybersecurity and guide users through features of the XploitAgent system.
...
only respond with short messages and don't add symbols like [*,#,@]`;

  return await callGemini(prompt + message);
}
